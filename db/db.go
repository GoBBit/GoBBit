...
func EnsureIndex(){
    ...
    db.C("topic").EnsureIndex(mgo.Index{Key: []string{"cid"}, Unique: true, DropDups: true})
    db.C("topic").EnsureIndex(mgo.Index{Key: []string{"last_update"}, Unique: true, DropDups: true})
